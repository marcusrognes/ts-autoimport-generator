...
| Flag               | Description                                                                 |
| ------------------ | --------------------------------------------------------------------------- |
| `--stripExtension` | Strip the remaining file extension from import paths (after `.ts`/`.tsx` is already removed) |
...
Source extensions (`.ts`, `.tsx`) are always stripped from import paths. Use `--stripExtension` to additionally strip any other trailing extension (e.g. `.actions`, `.module`).
